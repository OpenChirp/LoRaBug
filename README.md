...
* Reverse leakage from battery through voltage regulation circuitry has shown to draw **no measurable power**. Based on the datasheets, there is a possibility of 0.1 - 0.2uA draw.
